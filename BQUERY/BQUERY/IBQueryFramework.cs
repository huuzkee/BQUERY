...
namespace BQUERY
{
    public interface IBQueryFramework :  IFramework
    {
        ...
        IConnection Conn       ();
        IConnection Conn       ( String ConnectionName );

        IConnection CreateConnection(String ConnectionName);
        IConnection CreateConnection(String ConnectionName, Boolean isDefault );

        IBQueryFramework RegisterConnection(String ConnectionName, IConnection Connection);
        IBQueryFramework RegisterConnection(String ConnectionName, IConnection Connection, Boolean isDefault);
