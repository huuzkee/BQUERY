...
namespace BQUERY
{
    public interface IDiagnosticManager : IChild, IFramework, ISubscribe, INotify
    {

        // Request Diagnostic Attributes //

        Boolean IsActive { get; set;  }

        String Status { get; set; }// SQLCode   

        String ResultCode { get; set; }// SQLCode   

        String ResultReasonCode { get; set; }// SQLDBCode   

        String ErrorMessage { get; set;}// SQLErrText   

        String RecordCount { get; set; }// SQLNRows   

        String ResultMessage { get; set; }// SQLReturnData 
