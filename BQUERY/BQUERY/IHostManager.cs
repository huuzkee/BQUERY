...
namespace BQUERY
{
    public interface IHostManager : IChild, IFramework
    {
        IHost this[string HostName] { get; set; }

        IHost Create(String HostClass, String HostName);
        IHost Create(String HostName);

        IHostManager Destroy(String HostName);

        IHost Register(IHost Host, String HostName);
        IHostManager UnRegister(String HostName);

        IHost Select(String HostName);
