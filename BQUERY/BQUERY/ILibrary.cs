...
namespace BQUERY
{
    public interface ILibrary : IChild, IFramework
    {
        ...
        ITemplate Select(String Name);

        ILibrary Register();
        ILibrary RegisterAs(String Name);
        ILibrary Register(String Name, String AliasName);
        ILibrary Register( String Name );
        ILibrary RegisterAll();

        ITemplateIterator Directory();

        ITemplateIterator FileDirectory();

        long TemplatesRegistered();

        // Template Dictionary //

        ITemplate this[string Name] { get; set; }
