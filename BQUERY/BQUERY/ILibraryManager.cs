...
namespace BQUERY
{
    public interface ILibraryManager : IChild, IFramework
    {

        ILibrary DefaultLibrary { get; set; }
        String DefaultLibraryName { get; set; }
        
        ILibrary this[string LibName] { get; set; }

        ILibraryIterator Iterator();

        ILibrary Register(String Name, String LibFile);
        ILibrary UnRegister(String Name, String LibFile);

        ILibrary Create(String Name, String LibFile);
        ILibrary Delete(String Name );
        ILibrary Select(String Name);
        ILibrary Select();
