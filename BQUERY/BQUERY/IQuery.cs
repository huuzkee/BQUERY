...
using System;
using BQUERY.FOUNDATION;


namespace BQUERY
{
    public interface IQuery : IChild, IFramework, IQTable, IQEvents, IQService, IQReport, IQLink, IQComposite, IQDocument, IQBuild, IQXExpressionSupport, IQImplementation, ISubscribe, INotify 
    {
