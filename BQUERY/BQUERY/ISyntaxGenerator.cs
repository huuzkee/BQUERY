...
namespace BQUERY
{
    public interface ISyntaxGenerator : IChild, IFramework
    {

        ISyntaxGenerator From(String LanguageName);

        ISyntaxGenerator From();

        ISyntaxGenerator To(String LanguageName);

        ISyntaxGenerator To();

        String Using(String Source );
