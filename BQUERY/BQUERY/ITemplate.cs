...
namespace BQUERY
{
    public interface ITemplate : IChild, IFramework
    {
        Boolean Persistent { get; }
        String QueryType { get; }

        String Syntax { get; set; }
        String TemplateName { get; set; }
        String TemplateLibraryName { get; set; }

        ITemplate Export ( String Filename );
        ITemplate Import(String Filename);
