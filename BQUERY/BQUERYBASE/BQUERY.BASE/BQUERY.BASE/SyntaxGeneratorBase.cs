...
namespace BQUERY.BASE
{
    public class SyntaxGeneratorBase : ISyntaxGenerator
    {
        string _framework = "BASE";
        object _parent;

        public ISyntaxGenerator From(string LanguageName)
        {
            throw new NotImplementedException();
        }

        public ISyntaxGenerator From()
        {
            throw new NotImplementedException();
        }

        public ISyntaxGenerator To(string LanguageName)
        {
            throw new NotImplementedException();
        }

        public ISyntaxGenerator To()
        {
            throw new NotImplementedException();
        }

        public string Using(string Source)
        {
            throw new NotImplementedException();
        }
