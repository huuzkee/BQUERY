...
namespace BQUERY.BASE
{
    public class HostManagerBase : IHostManager
    {
        string _framework = "BASE";
        object _parent;
        
        public IHost this[string HostName]
        {
            get
            {
        ...
        public IHost Create(string HostClass, string HostName)
        {
            throw new NotImplementedException();
        }

        public IHost Create(string HostName)
        {
            throw new NotImplementedException();
        }

        public IHostManager Destroy(string HostName)
        {
            throw new NotImplementedException();
        }

        public IHost Register(IHost Host, string HostName)
        {
            throw new NotImplementedException();
        }

        public IHostManager UnRegister(string HostName)
        {
            throw new NotImplementedException();
        }

        public IHost Select(string HostName)
        {
            throw new NotImplementedException();
        }
